...
# Add parent directory to path to import spirit_monitoring
...
def test_import():
    ...
    try:
        ...
        assert hasattr(spirit_monitoring, 'lambda_handler')
    except ImportError as e:
        pytest.fail(f"Failed to import spirit_monitoring: {e}")

@patch('requests.get')
def test_spirit_com_returns_200(mock_get):
    """Test successful response from spirit.com"""
    # Import here to avoid issues
    from spirit_monitoring import lambda_handler
